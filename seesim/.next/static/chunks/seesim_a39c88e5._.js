...
function PromptInputBar(param) {
    let { prompt, onChange, onSubmit, disabled, onAttach, onNewChat, onSaveChat, initialAttachedName, onBoost } = param;
    _s();
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSupabaseClient"])();
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        onChange: async (e)=>{
                            ...
                            try {
                                ...
                                const path = "attachments/".concat(Date.now(), "_").concat(Math.random().toString(36).slice(2), "_").concat(file.name);
                                ...
                                if (!upErr) {
                                    ...
                                    if (publicUrl) {
                                        ...
                                        onAttach === null || onAttach === void 0 ? void 0 : onAttach(publicUrl, file);
                                        return;
                                    }
                                }
...
_s(PromptInputBar, "c9GLYCgRFpG2LI8zNoZeXw9yXe8=");
_c = PromptInputBar;
var _c;
...
function ModelResponseCard(param) {
    let { title, status, content, error, onContinue } = param;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center gap-2",
                        children: [
                            onContinue && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
        ...
        "MobileSidebar.useEffect": ()=>{
            async function load() {
                try {
                    ...
                    const byKey = {};
                    const add = {
                        "MobileSidebar.useEffect.load.add": function(c) {
                            let prefer = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
                            if (!c) return;
                            const prompt = typeof c.prompt === "string" ? c.prompt : "";
                            const created = c.created_at || c.createdAt || "";
                            const id = typeof c.id === "string" && c.id ? c.id : "".concat(prompt, "|").concat(created);
                            if (prefer || !(id in byKey)) byKey[id] = c;
                        }
                    }["MobileSidebar.useEffect.load.add"];
                    // Local first
                    ...
                    const merged = Object.values(byKey).sort({
                        "MobileSidebar.useEffect.load.merged": (a, b)=>{
                    ...
                    const uniqByPrompt = merged.filter({
                        "MobileSidebar.useEffect.load.uniqByPrompt": (c)=>{
                    ...
                    }["MobileSidebar.useEffect.load.uniqByPrompt"]);
                                    ...
                                    children: [
                                        ...
                                        convos.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: convos.map((c, idx)=>{
                                                const key = (c === null || c === void 0 ? void 0 : c.id) || "".concat((c === null || c === void 0 ? void 0 : c.prompt) || "", "|").concat((c === null || c === void 0 ? void 0 : c.created_at) || (c === null || c === void 0 ? void 0 : c.createdAt) || "", "|").concat(idx);
                                                const hasId = typeof (c === null || c === void 0 ? void 0 : c.id) === "string" && c.id.length > 0;
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
function DashboardClient(param) {
    ...
    _s();
    const { llms, setLLMs, responses, setResponse, selectedLLMIds, setSelectedLLMIds, promptBoostLLMId, setPromptBoostLLMId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    ...
    const [attachedName, setAttachedName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [attachedType, setAttachedType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$app$2f$dashboard$2f$components$2f$PromptInputBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        onAttach: (dataUrl, file)=>{
                            ...
                            setAttachedName((file === null || file === void 0 ? void 0 : file.name) || null);
                            setAttachedType((file === null || file === void 0 ? void 0 : file.type) || null);
                        },
...
_s(DashboardClient, "cwRRa8eN5kPmnlUBGnQ/lucDoJo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
...
//# sourceMappingURL=seesim_a39c88e5._.js.map