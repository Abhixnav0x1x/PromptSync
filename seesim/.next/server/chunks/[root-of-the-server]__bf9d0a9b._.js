module.exports = [
"[project]/seesim/.next-internal/server/app/api/llms/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/seesim/app/api/llms/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PatchSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    model_name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1).optional(),
    api_key: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1).optional(),
...
async function PATCH(req, { params }) {
    ...
    if (!parsed.success) return __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const { data, error } = await supabase.from("llms").update(updates).eq("id", params.id).select("id, user_id, model_name, nickname, created_at").single();
...
async function DELETE(_req, { params }) {
    ...
    const { error, count } = await supabase.from("llms").delete({
        count: "exact"
    ...
    if (!count) return __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Not found"
    }, {
        status: 404
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf9d0a9b._.js.map