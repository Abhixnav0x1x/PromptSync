module.exports = [
"[project]/seesim/.next-internal/server/app/api/conversations/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/seesim/app/api/conversations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data, error } = await supabase.from("conversations").select("id, prompt, results, image_url, file_name, file_type, created_at").eq("user_id", user.id).order("created_at", {
        ascending: false
    });
...
async function POST(req) {
    ...
    if (!prompt || typeof prompt !== "string") return __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Invalid prompt"
    }, {
        status: 400
    });
    if (!Array.isArray(results)) return __TURBOPACK__imported__module__$5b$project$5d2f$seesim$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14bdae75._.js.map